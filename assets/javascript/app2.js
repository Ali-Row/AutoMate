            ...
            <div class='col-xs-4 p-2 mt-3 mx-auto'>
                <div class="card rounded-0" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><h6>Mileage:</h6>${vehicle[i].Mileage} miles</li>
                        <li class="list-group-item"><h6>Oil Change Interval:</h6>${vehicle[i].Interval} miles</li>
                        <li class="list-group-item"><h6>Oil Change Due:</h6>${nextServiceDue(vehicle[i].Mileage, vehicle[i].Interval)} miles</li>
                    </ul>
                    <div class="card-body">
